export const meta = {
  name: 'feat-audit-500',
  description: 'The audit: 500 frozen feats on Opus — extract requirements from text, then check the app delivers them, on BOTH halves (what the builder asks, what the sheet does)',
  phases: [
...
const EVIDENCE = `${R}scripts/audit/audit-500-evidence.json`
...
const SAMPLE = `${R}scripts/audit/feat-500.json`
const TOTAL = 500
const SIZE = 5
