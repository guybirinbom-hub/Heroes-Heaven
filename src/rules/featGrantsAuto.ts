...
export const FEAT_SKILL_GRANTS: Record<string, FeatGrant> = {
  ...
  'anadi-lore': { skills: { crafting: 'trained', survival: 'trained', 'lore:anadi': 'trained' } },
  'ancient-memories': { skillChoices: [{ options: 'any', rank: 'trained' }] },
  'android-lore': { skills: { crafting: 'trained', thievery: 'trained', 'lore:android': 'trained' }, redundantFallback: true },
  'angelkin': { skills: { society: 'trained' } },
  ...
  'athamaru-lore': { skills: { athletics: 'trained', nature: 'trained' } },
  ...
  'axiomatic-lore': { skills: { diplomacy: 'trained', society: 'trained', 'lore:axis': 'trained' } },
  ...
  'bard-dedication': { skills: { occultism: 'trained', performance: 'trained' } },
  'bardic-lore': { skills: { 'lore:bardic': 'trained' } },
  'battle-harbinger-dedication': { skillChoices: [{ options: 'any', rank: 'trained' }] },
  ...
  'bloodrager-dedication': { skillChoices: [{ options: 'any', rank: 'trained' }] },
  'bouncy-goblin': { skills: { acrobatics: 'trained' } },
  ...
  'campfire-chronicler-dedication': { skills: { religion: 'trained', survival: 'trained' } },
  'captain-dedication': { skillChoices: [{ options: ['diplomacy', 'intimidation'], rank: 'trained' }] },
  'captivator-dedication': { skillChoices: [{ options: ['deception', 'diplomacy'], rank: 'trained' }] },
  'caretakers-intuition': { skills: { nature: 'trained' } },
  'catch-the-details': { skills: { society: 'trained' }, redundantFallback: true },
  'catfolk-lore': { skills: { acrobatics: 'trained', survival: 'trained', 'lore:catfolk': 'trained' } },
  ...
  'centaur-lore': { skills: { medicine: 'trained', nature: 'trained', 'lore:centaur': 'trained' } },
  'centaur-weapon-familiarity': { weaponFamiliarity: {'weapons':['lance','longbow','longspear','shortbow','spear'],'rank':'trained'} },
  'champion-dedication': { skills: { religion: 'trained' }, armor: { light: 'trained', medium: 'trained' } },
  'changeling-lore': { skills: { deception: 'trained', occultism: 'trained', 'lore:hag': 'trained' } },
  'childlike-plant': { skills: { deception: 'trained' }, redundantFallback: true },
  'clan-lore': { skillChoices: [{ options: ['arcana', 'athletics', 'crafting', 'diplomacy', 'intimidation', 'medicine', 'nature', 'occultism', 'religion', 'society', 'survival', 'thievery'], rank: 'trained' }, { options: ['arcana', 'athletics', 'crafting', 'diplomacy', 'intimidation', 'medicine', 'nature', 'occultism', 'religion', 'society', 'survival', 'thievery'], rank: 'trained' }], loreChoices: 1 },
  'clan-pistol': { weaponFamiliarity: {'weapons':['clan-pistol'],'rank':'trained'} },
  'cleric-dedication': { skills: { religion: 'trained' }, skillChoices: [{ options: 'any', rank: 'trained' }] },
  ...
  'corpse-tender-dedication': { skills: { diplomacy: 'trained' } },
  ...
  'divine-dragonblood': { skills: { religion: 'trained' } },
  ...
  'dragonscaled-lore': { skills: { intimidation: 'trained', 'lore:dragon': 'trained' }, skillChoices: [{ options: ['arcana', 'nature', 'occultism', 'religion'], rank: 'trained' }] },
  'druid-dedication': { skills: { nature: 'trained' }, skillChoices: [{ options: 'any', rank: 'trained' }] },
  ...
  'dustsoul': { skills: { survival: 'trained' } },
  'dwarven-lore': { skills: { crafting: 'trained', religion: 'trained', 'lore:dwarven': 'trained' } },
  ...
  'edgewatch-detective-dedication': { skillChoices: [{ options: 'any', rank: 'trained' }, { options: 'any', rank: 'trained' }, { options: 'any', rank: 'trained' }] },
  'eldritch-researcher-dedication': { skillChoices: [{ options: ['arcana', 'occultism'], rank: 'expert' }] },
  'elemental-embellish': { skills: { intimidation: 'trained' } },
  'elemental-lore': { skills: { survival: 'trained' }, skillChoices: [{ options: ['arcana', 'nature'], rank: 'trained' }], loreChoices: 1 },
  'elemental-trade': { skills: { crafting: 'trained' } },
  'elven-lore': { skills: { arcana: 'trained', nature: 'trained', 'lore:elven': 'trained' } },
  'embodied-legionary-subjectivity': { skills: { arcana: 'trained', athletics: 'trained', 'lore:warfare': 'trained' } },
  'endless-memories': { skillChoices: [{ options: 'any', rank: 'expert' }] },
  ...
  'fetchling-lore': { skills: { occultism: 'trained', stealth: 'trained', 'lore:shadow-plane': 'trained' } },
  ...
  'flexible-form': { skills: { acrobatics: 'trained' } },
  ...
  'gemsoul': { skills: { performance: 'trained' } },
  ...
  'ghoran-lore': { skills: { arcana: 'trained', nature: 'trained', 'lore:ghoran': 'trained' } },
  ...
  'goblin-lore': { skills: { nature: 'trained', stealth: 'trained', 'lore:goblin': 'trained' } },
  ...
  'grippli-lore': { skills: { nature: 'trained', stealth: 'trained', 'lore:grippli': 'trained' } },
  ...
  'gunslinger-dedication': { skillChoices: [{ options: ['acrobatics', 'deception', 'intimidation', 'stealth', 'athletics', 'thievery', 'arcana'], rank: 'trained' }] },
  'halfling-lore': { skills: { acrobatics: 'trained', stealth: 'trained', 'lore:halfling': 'trained' } },
  ...
  'hobgoblin-lore': { skills: { athletics: 'trained', crafting: 'trained', 'lore:hobgoblin': 'trained' } },
  ...
  'idyllkin': { skills: { nature: 'trained' } },
  ...
  'jotunborn-grappler': { skills: { athletics: 'trained' } },
  'jotunborn-lore': { skills: { occultism: 'trained', survival: 'trained', 'lore:jotunborn': 'trained' } },
  'juggler-dedication': { skills: { performance: 'trained' }, redundantFallback: true },
  'kholo-lore': { skills: { stealth: 'trained', survival: 'trained' } },
  ...
  'kobold-lore': { skills: { stealth: 'trained', thievery: 'trained', 'lore:kobold': 'trained' } },
  ...
  'leshy-lore': { skills: { nature: 'trained', stealth: 'trained', 'lore:leshy': 'trained' } },
  ...
  'lizardfolk-lore': { skills: { nature: 'trained', survival: 'trained', 'lore:iruxi': 'trained' }, skillChoices: [{ options: ['nature', 'occultism'], rank: 'trained' }] },
  ...
  'merfolk-lore': { skills: { arcana: 'trained', society: 'trained', 'lore:merfolk': 'trained' } },
  'minotaur-lore': { skills: { society: 'trained', stealth: 'trained', 'lore:minotaur': 'trained' } },
  'miresoul': { skills: { acrobatics: 'trained' } },
  ...
  'monk-dedication': { skillChoices: [{ options: 'any', rank: 'trained' }] },
  ...
  'nephilim-lore': { skills: { religion: 'trained' }, skillChoices: [{ options: 'any', rank: 'trained' }] },
  'nosois-mask': { skills: { intimidation: 'trained' }, redundantFallback: true },
  'occult-dragonblood': { skills: { occultism: 'trained' } },
  ...
  'orc-lore': { skills: { athletics: 'trained', survival: 'trained', 'lore:orc': 'trained' } },
  ...
  'progenitor-lore': { skills: { deception: 'trained', occultism: 'trained' }, loreChoices: 1 },
  ...
  'pure-legion-enforcer-dedication': { conditionalSkills: { intimidation: { base: 'trained', upgraded: 'expert' }, religion: { base: 'trained', upgraded: 'expert' } } },
  'quah-bond': { skillChoices: [{ options: 'any', rank: 'trained' }] },
  'quicksoul': { skills: { acrobatics: 'trained' } },
  'ranger-dedication': { skills: { survival: 'trained' }, redundantFallback: true },
  'ratfolk-lore': { skills: { acrobatics: 'trained', stealth: 'trained', 'lore:ratfolk': 'trained' } },
  ...
  'round-ears': { skills: { deception: 'trained' } },
  ...
  'sage-of-scattered-leaves': { skills: { religion: 'trained', nature: 'trained', 'lore:yaksha': 'trained' } },
  'samsaran-lore': { skills: { religion: 'trained', society: 'trained', 'lore:samsaran': 'trained' } },
  'sarangay-lore': { skills: { nature: 'trained', survival: 'trained', 'lore:sarangay': 'trained' } },
  'scholars-inheritance': { skills: { crafting: 'trained' } },
  ...
  'sinister-appearance': { skills: { intimidation: 'trained' } },
  ...
  'sociable': { skills: { diplomacy: 'trained' } },
  'sorcerer-dedication': { skillChoices: [{ options: 'any', rank: 'trained' }, { options: 'any', rank: 'trained' }] },
  ...
  'surface-culture': { skills: { society: 'trained' }, loreChoices: 1 },
  'surki-lore': { skills: { survival: 'trained' }, skillChoices: [{ options: 'any', rank: 'trained' }] },
  'svetocher': { skills: { diplomacy: 'trained' }, redundantFallback: true },
  'swashbuckler-dedication': { skillChoices: [{ options: 'any', rank: 'trained' }] },
  'tangle-of-limbs': { skills: { athletics: 'trained' }, redundantFallback: true },
  'tanuki-lore': { skills: { deception: 'trained', performance: 'trained', 'lore:tanuki': 'trained' } },
  'tattooed-historian-dedication': { skillChoices: [{ options: ['diplomacy', 'performance'], rank: 'trained' }] },
  'tengu-lore': { skills: { society: 'trained', survival: 'trained', 'lore:tengu': 'trained' } },
  'thaumaturge-dedication': { skillChoices: [{ options: 'any', rank: 'trained' }] },
  'tinkering-fingers': { skills: { crafting: 'trained' } },
  ...
  'tripkee-lore': { skills: { nature: 'trained', stealth: 'trained', 'lore:tripkee': 'trained' } },
  ...
  'vampire-lore': { skills: { society: 'trained', religion: 'trained', 'lore:vampire': 'trained' } },
