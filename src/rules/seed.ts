...
export const seedContent: ContentDatabase = {
  ...
  items: {
    ...
    'crossbow-bolts': { id: 'crossbow-bolts', itemType: 'consumable', name: 'Crossbow bolts', level: 0, price: { sp: 1 }, packOf: 10, bulk: 0.1, traits: [], rarity: 'common', consumableType: 'ammunition', description: 'A quiver of bolts; one is spent per shot.', source: ORC },
